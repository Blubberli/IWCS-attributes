...
class SingleWordBertClassifier(nn.Module):
    """
    ...
    def __init__(self, layer_num, input_dim, hidden_dim, label_nr, dropout_rate):
        super(SingleWordBertClassifier, self).__init__()
    ...
    def forward(self, batch):
        ...
        weighted_modifier = self._layer_weights(batch["head_rep"].to(device))
        ...
        x = F.relu(self.hidden_layer(weighted_modifier))
